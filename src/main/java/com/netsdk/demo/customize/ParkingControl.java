...
////////////////////////////////////////////////////////////////
private String m_strIp 				    = "172.24.31.180";
...
//	}
	...
	public void GetTrafficLatticeScreen() {
		//获取
		int emCfgOpType=NET_EM_CFG_OPERATE_TYPE.NET_EM_CFG_TRAFFIC_LATTICE_SCREEN;
		//入参
		NET_CFG_TRAFFIC_LATTICE_SCREEN_INFO msg=new NET_CFG_TRAFFIC_LATTICE_SCREEN_INFO();
...
public void RunTest()
{
	...
	menu.addItem(new CaseMenu.Item(this , "GetTrafficLatticeScreen" , "GetTrafficLatticeScreen"));
	menu.run();
}	
