...
import static com.netsdk.demo.customize.composeDemo.ComposeTools.getDate;

public class ComposeLogon {

    // 配置登陆地址，端口，用户名，密码
    private static String m_strIpAddr = "172.11.4.12";
     ...
     * @param haveReConnect the have reconnect instance 重连回调单例
     * @return the boolean
     */
