 ...
 */
 class NewPlayBackByRecordFileFrame  {
     ...
     * PlayDemo 构造
     */
    public  NewPlayBackByRecordFileFrame () {
...
//    		System.out.println("TimeDownLoadDataCallBack [ " + dwUser +" ]");
    ...
    // 查询录像文件
    public NetSDKLib.NET_RECORDFILE_INFO QueryFile() {

        NetSDKLib.NET_TIME  stuStartTime=new    NetSDKLib.NET_TIME();
        // 开始时间
        stuStartTime.dwYear = 2021;
        stuStartTime.dwMonth = 12;
        stuStartTime.dwDay = 15;
        stuStartTime.dwHour = 8;
        stuStartTime.dwMinute = 0;
        stuStartTime.dwSecond = 0;
        NetSDKLib.NET_TIME  stuEndTime=new    NetSDKLib.NET_TIME();
        // 结束时间
        stuEndTime.dwYear = 2021;
        stuEndTime.dwMonth = 12;
        stuEndTime.dwDay = 15;
        stuEndTime.dwHour = 10;
        stuEndTime.dwMinute = 0;
        stuEndTime.dwSecond = 0;
        ...
        //      NetSDKLib.LLong lFindHandle = netSdk.CLIENT_FindFile(loginHandle,-1,0,null,stuStartTime,stuEndTime,false,2000);
        ...
        //   netSdk.CLIENT_QueryRecordFile(loginHandle,-1,type,stuStartTime,stuEndTime,null,);


        boolean cRet = NetSdk.CLIENT_QueryRecordFile(m_hLoginHandle, -1, 0, stuStartTime, stuEndTime, null, numberFile, maxlen, outFileCoutReference, 5000, false);


        NetSDKLib.NET_RECORDFILE_INFO info =new NetSDKLib.NET_RECORDFILE_INFO();
        if(cRet) {
    ...
    private void StartPlayBack() {
        ...
        NetSDKLib.NET_RECORDFILE_INFO info = QueryFile();


        // public long CLIENT_PlayBackByRecordFile(LLong lLoginID,LPNET_RECORDFILE_INFO lpRecordFile,Pointer hWnd,fDownLoadPosCallBack cbDownLoadPos,Pointer dwUserData);
        m_hPlayHandle = NetSdk.CLIENT_PlayBackByRecordFile(m_hLoginHandle,info ,
...
public class NewPlayBackByRecordFile {
    public static void main(String[] args) {
        new NewPlayBackByRecordFileFrame();
    }
}