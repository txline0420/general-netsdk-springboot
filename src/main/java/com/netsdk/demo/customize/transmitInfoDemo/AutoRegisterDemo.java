...
public class AutoRegisterDemo {
    ...
    public void deviceLogin() {
        ...
        // 高安全登录  主动注册 
        NetSDKLib.LLong m_hLoginHandle = LoginModule.AutoRegisterLoginWithHighSecurity(key, ipAddr, port, username, password, deviceInfo.m_stDeviceInfo);
        ...
        // 启动业务 Demo
        TransmitInfoForWebDemo demo = new TransmitInfoForWebDemo(deviceInfo);
        demo.RunTest();
    ...
    public static void main(String[] args) {
    	AutoRegisterDemo launcher = new AutoRegisterDemo();
        launcher.InitTest();
        launcher.RunTest();
        launcher.EndTest();
    }
