...
/**
 * @author 47040
 * @since Created in 2021/5/13 9:21
 */
public class CrossRegionDetectionInfo implements SurfaceEventInfo {

    /**
     * 事件名称
     */
    private String eventName = "船只区域入侵";
