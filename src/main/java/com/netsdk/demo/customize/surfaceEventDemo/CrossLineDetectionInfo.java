...
/**
 * @author 47040
 * @since Created in 2021/5/12 13:47
 */
public class CrossLineDetectionInfo implements SurfaceEventInfo {

    /**
     * 事件名称
     */
    private String eventName = "船只绊线入侵";
