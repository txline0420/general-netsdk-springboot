...
public class RemoteUpgradeStatus {
public static final NetSDKLib netSdk = NetSDKLib.NETSDK_INSTANCE;
  ...
  ////////////////////////////////////////////////////////////////
     ...
     * 升级进度回调函数
     */
    private static class CdRemoteUpgradeCallBack implements fRemoteUpgradeCallBack {
		...
		public void invoke(LLong lLoginID, LLong lUpgradeID, int emState,
			...
			if (emState == EM_REMOTE_UPGRADE_CB_TYPE.EM_REMOTE_UPGRADE_CB_TYPE_APPENDING)
			{
     ...
     * 升级状态回调函数
     */
    private static class CdRemoteUpgraderStateCallback implements fRemoteUpgraderStateCallback {
    ...
    public static void main(String []args){
    	RemoteUpgradeStatus XM=new RemoteUpgradeStatus();
	    XM.InitTest();
	    XM.RunTest();
	    XM.LoginOut();
    }
