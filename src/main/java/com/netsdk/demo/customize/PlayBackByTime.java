...
class PlayBackFrame {
    ...
    private LLong m_hLoginHandle = new LLong(0); // 登录句柄
    private LLong m_hPlayHandle = new LLong(0);  // 回放句柄
    private LLong m_hDownLoadHandle = new LLong(0); // 下载录像句柄
    ...
    private class ControlPanel extends JPanel {
        ...
        public ControlPanel() {
            ...
            osdButton = new JButton("OSD Time");
            ...
            add(ctrlJTabbedPane, BorderLayout.CENTER);
            add(osdButton, BorderLayout.SOUTH);
            ...
            osdButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    boolean ret = NetSdk.CLIENT_GetPlayBackOsdTime(m_hPlayHandle, OsdTime, StartTime, EndTime);
                    if (!ret) {
                        System.err.println("Get OSD Time Failed! "+ ToolKits.getErrorCode());
                        return;
                    }
                    System.out.println("OSD Time: " + OsdTime.toStringTime());
                }
            });
        }
    }
...
//    		System.out.println("PlayBack DataCallBack [ " + dwUser +" ]");
    ...
    public class TimeDownLoadPosCallBack implements NetSDKLib.fTimeDownLoadPosCallBack {
        public void invoke(LLong lLoginID, int dwTotalSize, int dwDownLoadSize, int index, NetSDKLib.NET_RECORDFILE_INFO.ByValue recordfileinfo, Pointer dwUser) {
...
//    		System.out.println("TimeDownLoadDataCallBack [ " + dwUser +" ]");
    ...
    private void StartPlayBack() {
        ...
        m_hPlayHandle = NetSdk.CLIENT_PlayBackByTimeEx(m_hLoginHandle, m_channel.intValue(), m_startTime, m_stopTime,
                playWindow.getHWNDofFrame(), m_PlayBackDownLoadPos, null, m_dataCallBack, null);
    ...
    private JButton osdButton = new JButton("OSD Time");
