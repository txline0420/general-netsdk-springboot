...
////////////////////////////////////////////////////////////////
private String m_strIp 				    = "172.12.4.217";
...
public void FocusControl() {
	int nChannelID = 0 ;
	int  dwFocusCommand =2 ;  //dwFocusCommand = 2,为自动聚焦调节,调节焦点至最佳位置。nFocus和nZoom无效
	boolean ret = netSdk.CLIENT_FocusControl(loginHandle, nChannelID, dwFocusCommand, 0, 0, null, 3000);
	if(!ret) {
		System.err.println("FocusControl fial" + ToolKits.getErrorCode());
	}else {
		System.out.println("FocusControl success");
	}
}
...
public void RunTest()
{
	...
	menu.addItem(new CaseMenu.Item(this , "FocusControl" , "FocusControl"));	
	menu.run(); 
}	

public static void main(String[]args)
{		
	AutoFocus demo = new AutoFocus();
	demo.InitTest();
	demo.RunTest();
	demo.LoginOut();
}
