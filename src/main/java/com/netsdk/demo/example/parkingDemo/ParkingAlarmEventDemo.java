...
import com.netsdk.demo.example.parkingDemo.callback.DefaultMessageCallBack;
 ...
 */
public class ParkingAlarmEventDemo {
    ...
    private NetSDKLib.fMessCallBackEx1 messCallBack = DefaultMessageCallBack.getSingleInstance();
    ...
    public void InitTest() {
        ...
        netsdk.CLIENT_SetDVRMessCallBackEx1(messCallBack, null);   // 注册一般事件回调函数
...
//    private int m_nPort = 37777;
    ...
    public static void main(String[] args) {
        ParkingAlarmEventDemo demo = new ParkingAlarmEventDemo();
        demo.InitTest();
        demo.RunTest();
        demo.EndTest();
    }
