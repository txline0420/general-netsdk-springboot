...
public enum EM_CUSTOMER_DEV_SETTING_DOOR_METHOD {
	 ...
	 * 腕带码或人脸或身份证开门
	 */
	EM_CUSTOMER_DEV_SETTING_DOOR_METHOD_WRISTBAND_OR_FACE_OR_IDCARD(4, "腕带码或人脸或身份证开门"),
	/**
	 ...
	 * （人脸或身份证）+（码1或者码2）
	 */
	EM_CUSTOMER_DEV_SETTING_DOOR_METHOD_FACE_OR_IDCARD_AND_CODE1_OR_CODE2(8, "（人脸或身份证）+（码1或者码2）"),
	/**
	 * 人脸或码1或码2或者腕带码
	 */
